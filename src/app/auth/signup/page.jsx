...
import { SignUp, loginProvider } from "@/actions/auth";
            ...
            <div className="w-full max-w-md">
                <form action={formAction} className='bg-slate-800 p-6 sm:p-8 rounded-lg shadow-lg'>
                    <header className="mb-6 sm:mb-8 text-center">
                        <h1 className='text-2xl sm:text-3xl font-bold'>Crear una cuenta</h1>
                        <p className="text-slate-400 mt-2 text-sm sm:text-base">Únete para empezar a gestionar tus tareas</p>
                    </header>

                    <div className="mb-4">
                        <label className='block text-slate-400 text-sm font-bold mb-2' htmlFor="name">Nombre Completo</label>
                        <input
                    ...
                    <div className="mb-4">
                        <label className='block text-slate-400 text-sm font-bold mb-2' htmlFor="username">Nombre de usuario</label>
                        <input
                            className='w-full bg-slate-700 p-3 rounded-md focus:outline-none focus:ring-2 focus:ring-sky-500 transition text-slate-200'
                            name="username"
                            id="username"
                    ...
                    <div className='flex flex-col gap-4'>
                        <SubmitButton className="bg-sky-600 hover:bg-sky-500 text-white disabled:bg-sky-800 disabled:cursor-not-allowed">
                            Registrarse
                        </SubmitButton>
                    </div>
